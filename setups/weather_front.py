...
for index, w in enumerate(displayed_weathers):
    ...
    xbase = 44*index
    client.add_graphics_submessage('front', 'bitmap', image = "bitmaps/weather_icons/{0}.png".format(icon), left = xbase, top = 0)
    client.add_graphics_submessage('front', 'bitmap', image = "bitmaps/weather_icons/temperature7.png", left = xbase+18, top = 0)
    client.add_graphics_submessage('front', 'bitmap', image = "bitmaps/weather_icons/wind7.png", left = xbase+18, top = 9)
    client.add_graphics_submessage('front', 'text', text = "{0:.1f}".format(temp), font = "Flipdot8_Narrow", left = xbase+25, top = 0)
    client.add_graphics_submessage('front', 'text', text = "{0:.1f}".format(wind), font = "Flipdot8_Narrow", left = xbase+25, top = 9)
